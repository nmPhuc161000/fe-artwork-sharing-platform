...
function Footer({ isLoginPage, isRegisterPage,isRecoveryPage, isEmailOTP }) { // Thêm isRegisterPage vào props
  if (isLoginPage || isRegisterPage || isRecoveryPage || isEmailOTP) { // Ẩn footer nếu là trang Login hoặc Register
    return null;
  }
